---
description: Gemini CLI を使用したコードレビュー・分析・相談を実行する。使用場面: (1) コードレビュー依頼時、(2) 実装方針の相談、(3) バグの調査、(4) リファクタリング提案、(5) 解消が難しい問題の調査。トリガー: "gemini", "geminiでレビュー", "geminiに相談", "/gemini"
---
